...
- [Explore model evaluation](explore_model_evaluation.qmd) walks through comparing multiple candidate models
- [Explore caching](../../getting_started/explore_caching.qmd) shows how to skip recomputation across iterations
