...
- [Explore model evaluation](explore_model_evaluation.qmd) compares multiple models on held-out data
- [Your first build](../core_tutorials/your_first_build.qmd) packages your training pipeline as a portable artifact
