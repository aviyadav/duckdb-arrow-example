...
The output shows you the chain of operations Xorq performs when you execute the expression. This is your expression graph.

Now that you've seen what Xorq plans to do, run the computation and see the results.
...
But what happens if you don't defer? Compare the two approaches to see why deferred execution matters.
...
- [Your first build](../tutorials/core_tutorials/your_first_build.qmd) explains how Xorq captures expressions as portable manifests
